...
class PlayerResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'birth_date' => $level >= $this->show_birth_date ?  date("j.n.Y", strtotime($this->birth_date))  : null,
            'age' => $level >= $this->show_birth_date ? $this->age : null,
            ...
            'user' => $level >= $this->show_user ? $this->user->name : null,
